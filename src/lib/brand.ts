 ...
 * begins with "Spot"; "X for Spotify" is the allowed form. The repository is
 * called spotify-ai-organizer, but the public name and the name registered in
 * the Spotify Developer Dashboard must come from here.
 */
export const BRAND = {
  name: "Vibeshelf",
  qualifier: "for Spotify",
